...
local function update()
    ...
    mainMonitor.blit("i just really", colors.black, colors.red)
    mainMonitor.setCursorPos(1, 2)
    mainMonitor.blit("really really", colors.black, colors.red)
    mainMonitor.setBackgroundColor(colors.purple)
    mainMonitor.setCursorPos(1, 3)
    mainMonitor.blit("like tatsuki ", colors.black, colors.purple)
    mainMonitor.setBackgroundColor(colors.blue)
    mainMonitor.setCursorPos(1, 4)
    mainMonitor.blit("fujimoto's   ", colors.black, colors.blue)
    mainMonitor.setCursorPos(1, 5)
    mainMonitor.blit("manga        ", colors.black, colors.blue)
